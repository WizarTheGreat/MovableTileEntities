        ...
        if (block.getType() == Material.PISTON || block.getType() == Material.STICKY_PISTON) {
            ...
            if (power > 0) {
                ...
                if (blockData instanceof Directional) {
                    ...
                    Block oldBlock = block.getRelative(direction.getBlockX() * one, direction.getBlockY() * one, direction.getBlockZ() * one);
                    Block newBlock = block.getRelative(
                            direction.getBlockX() * two,
                            direction.getBlockY() * two,
                            direction.getBlockZ() * two);
                    checkBlock(newBlock);
